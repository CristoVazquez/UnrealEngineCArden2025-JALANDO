...
#include "EUCArden/PlatformActor.h"
...
EUCARDEN_API UClass* Z_Construct_UClass_APlatformActor();
EUCARDEN_API UClass* Z_Construct_UClass_APlatformActor_NoRegister();
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_APlatformActor_Statics::NewProp_CollisionComponent = { "CollisionComponent", nullptr, (EPropertyFlags)0x00100000000a001d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(APlatformActor, CollisionComponent), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CollisionComponent_MetaData), NewProp_CollisionComponent_MetaData) };
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_APlatformActor_Statics::NewProp_MovementAmplitud = { "MovementAmplitud", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(APlatformActor, MovementAmplitud), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MovementAmplitud_MetaData), NewProp_MovementAmplitud_MetaData) };
...
void Z_Construct_UClass_APlatformActor_Statics::NewProp_bMovingRight_SetBit(void* Obj)
{
	((APlatformActor*)Obj)->bMovingRight = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APlatformActor_Statics::NewProp_bMovingRight = { "bMovingRight", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(APlatformActor), &Z_Construct_UClass_APlatformActor_Statics::NewProp_bMovingRight_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bMovingRight_MetaData), NewProp_bMovingRight_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APlatformActor_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APlatformActor_Statics::NewProp_MovementAmplitud,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APlatformActor_Statics::NewProp_InitialLocation,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APlatformActor_Statics::NewProp_bMovingRight,
};
...
template<> EUCARDEN_API UClass* StaticClass<APlatformActor>()
{
	return APlatformActor::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_Usuario_Documents_GitHub_UnrealEngineCArden2025_EUCArden_Source_EUCArden_PlatformActor_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_APlatformActor, APlatformActor::StaticClass, TEXT("APlatformActor"), &Z_Registration_Info_UClass_APlatformActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APlatformActor), 238935725U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Usuario_Documents_GitHub_UnrealEngineCArden2025_EUCArden_Source_EUCArden_PlatformActor_h_3018790425(TEXT("/Script/EUCArden"),
	Z_CompiledInDeferFile_FID_Users_Usuario_Documents_GitHub_UnrealEngineCArden2025_EUCArden_Source_EUCArden_PlatformActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Usuario_Documents_GitHub_UnrealEngineCArden2025_EUCArden_Source_EUCArden_PlatformActor_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
